...
public class ServiceListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        serviceList = database.getReference("Service").child(Common.shopSelected);
        ...
        layoutBottomSheet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(ServiceListActivity.this, CartFixedActivity.class);
...
//                setCollapsingToolbarTitle(currentShop.getShopName());
                ...
                Common.shopLocationSelected = currentShop.getShopLatlng();
    ...
    public void onBackPressed() {
        ...
        Common.pickupLocationSelected = "0,0";
        Common.pickupLocationNameSelected = "Please select pickup location";
        Common.shopLocationSelected = "";
